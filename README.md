...
- [Usage](#usage)
  ...
  - [Download yc company images _(optional)_](#download-yc-company-images-optional)
...
### Download yc company images _(optional)_
...
Also, feel free to contribute to the [YC Startup Map repository](https://github.com/brysonbw/ycstartupmap.com), which visualizes the collected and scraped data.
